    ...
    <div className='w-full bg-gray-950 relative py-32 overflow-hidden'>
      ...
      <div className='flex flex-col lg:flex-row items-center justify-center w-full max-w-[1400px] mx-auto px-6 lg:px-12 xl:px-24 gap-16 relative z-10'>
        ...
        >
          ...
          <a href="#" className="mt-4 self-start bg-yellow-400 hover:bg-yellow-500 text-gray-950 px-8 py-3 rounded-full font-bold tracking-wide transition-all shadow-xl shadow-yellow-400/20">
             Explore Courses
          </a>
        </motion.div>
        ...
        >
          ...
          <a href="#" className="self-center lg:self-end text-yellow-400 font-bold group flex items-center gap-2 hover:text-yellow-300">
