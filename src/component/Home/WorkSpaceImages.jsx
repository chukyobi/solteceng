  ...
  return (
    ...
    >
      <div className='w-8 sml:w-12 h-8 sml:h-12 bg-[#f1f1f1] ml-[-32px] rounded-[50%] flex items-center justify-center'>
        <img src={Next?.src || Next} className='w-2.5 sml:w-3.5 ml-0 sml:ml-0' alt='' />
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className='w-8 sml:w-12 h-8 sml:h-12 bg-[#f1f1f1] rounded-[50%] flex items-center justify-center'>
        <img src={Prev?.src || Prev} className='w-2.5 sml:w-3.5 ml-[-3px] sml:ml-0' alt='' />
      </div>
    </div>
  );
}
      ...
      <div className='hidden lg:block'>
        <div className='lg:h-[461px]  flex flex-col mdl:flex-row gap-4 mdl:gap-8 lg:gap-6 items-center justify-center'>
          ...
          <div className='lgl:h-[378px] '>
            <img
              src={OfficeLocation?.src || OfficeLocation}
